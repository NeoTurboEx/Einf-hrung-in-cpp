...
//implement the Input function to read the velocity files into arrays
void Input(double uprime[], double vprime[], double wprime[], const int i, const int ncells)
{
      ...
      {
         infile >> uprime[j];             // read u' into an array 
         infile >> vprime[j];             // read v' into an array 
         infile >> wprime[j];             // read w' into an array 
      }
}
